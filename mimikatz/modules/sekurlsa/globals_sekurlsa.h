...
typedef struct _KUHL_M_SEKURLSA_CONTEXT {
	PKULL_M_MEMORY_HANDLE hLsassMem;  //句柄指针
	KUHL_M_SEKURLSA_OS_CONTEXT osContext;  //操作系统上下文 包括版本信息等
...
typedef struct _KIWI_BASIC_SECURITY_LOGON_SESSION_DATA {  //Windows登录会话基本信息的核心数据结构
	PKUHL_M_SEKURLSA_CONTEXT	cLsass;  //上下文指针
	const KUHL_M_SEKURLSA_LOCAL_HELPER * lsassLocalHelper;  //本地助手 
	PLUID						LogonId;
